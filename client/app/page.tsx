...
export default function Home() {
  return (
    ...
    <div className='bg-[#F5F2EE] h-full w-full border-[#4d2d18] rounded-lg border-4 overflow-hidden relative flex justify-center items-center'>
          ...
          <div className='z-10 flex flex-col justify-center max-w-[99vw] w-[360px] md:w-[610px] bg-[#F5F2EE] h-52 border-[#4d2d18] border-2 rounded-lg py-8 relative mb-16 '>
              <span className=' w-4 h-4 rounded-full bg-[#4d2d18] absolute bottom-[200px] left-[351px] md:left-[601px] animate-ping'></span>
              <p className={` ${Com.className} text-[#4d2d18] text-base xs:text-2xl md:text-4xl w-max mx-auto`}>
                  Library Management System
              </p>
              <div className="w-max mx-auto space-x-8  ">
                <button className={` ${bar.className} bg-[#4d2d18] w-40 py-2 mt-3 rounded-lg`}>
                  Get Started
                </button>
              </div>
          </div>  
